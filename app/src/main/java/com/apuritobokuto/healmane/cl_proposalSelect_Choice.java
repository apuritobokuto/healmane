...
public class cl_proposalSelect_Choice extends AppCompatActivity {
        ...
        try {
            ...
            proposallist.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                public void onItemClick(AdapterView<?>parent, View view, int position,long id) {
                    ...
                    Intent intent = new Intent(getApplication(), cl_proposalSelect_Details1.class);
